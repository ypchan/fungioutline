...
#' names. Taxon names are first resolved through [get_lineage()] with the
#' packaged [fungi_taxon_index] unless `outline` or `taxon_index` is supplied.
#' Results are cached by database, query, and `retmax`.
#'
